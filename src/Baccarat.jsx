  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize:13, fontWeight:700, color:isRed?"#c0392b":"#1a1a1a", lineHeight:1 }}>{card.r}</div>
        <div style={{ fontSize:13, color:isRed?"#c0392b":"#1a1a1a", lineHeight:1 }}>{card.s}</div>
        <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, color:isRed?"#c0392b":"#1a1a1a" }}>{card.s}</div>
        <div style={{ fontSize:13, fontWeight:700, color:isRed?"#c0392b":"#1a1a1a", lineHeight:1, alignSelf:"flex-end", transform:"rotate(180deg)" }}>{card.r}</div>
      </div>
    </div>
  );
}
...
function HandArea({ label, cards, score, showScore, accentColor, isWinner, glowAnim, dragon7, panda8 }) {
  return (
    <div style={{
      ...
      {/* Cartas */}
      <div style={{ display:"flex", gap:6, flexWrap:"wrap", minHeight:98 }}>
        {cards.map((c, i) => (
