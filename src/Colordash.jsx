...
const OBJ_SPEED_MAX  = 9;
const OBJ_SPEED_INC  = 0.003;      //0.0015 aceleración gradual de los objetos
const SPAWN_INTERVAL_INIT = 1600;   // intervalo inicial de spawn (ms)
const SPAWN_INTERVAL_MIN  = 500;     //650 límite de spawn (máxima dificultad)
